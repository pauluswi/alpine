...
import (
	...
	"github.com/pauluswi/alpine/internal/config"
	"github.com/pauluswi/alpine/internal/errors"
	"github.com/pauluswi/alpine/internal/healthcheck"
	"github.com/pauluswi/alpine/internal/pin"
	"github.com/pauluswi/alpine/pkg/accesslog"
...
func buildHandler(logger log.Logger, db *dbcontext.DB, cfg *config.Config) http.Handler {
	...
	pin.RegisterHandlers(rg.Group(""),
		pin.NewService(pin.NewRepository(db, logger), logger),
		authHandler, logger,
	)
